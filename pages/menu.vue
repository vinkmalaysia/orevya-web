  ...
  <main class="relative py-24 isolate overflow-hidden bg-[#2c2a2a]">
    ...
    <section>
      <div class="text-center mt-4 mb-12">
        <h1 class="inline-block px-4 py-1 font-Jost border-y border-[#8a7d4d] text-2xl xl:text-4xl text-white/80 font-medium xl:font-normal uppercase">Our Menu</h1>
      </div>
      <section class="flex flex-col 2xl:flex-row justify-center">
        <section class="menu-section">
          ...
          <ul class="menu-list" v-motion :initial="{ opacity: 0, y: 200 }" :visibleOnce="{ opacity: 1, y: 0, transition: { type: 'easeIn', duration: 600, delay: 100 } }">
            <li>Crab Cake</li>
